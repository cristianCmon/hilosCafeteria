...
\title{\LARGE \textbf{Documentación de Proyecto - Join Cafetería} \\[2ex] \Large Programación de Servicios y Procesos}
...
ha encargado la realización de una tarea que consiste en crear un programa en \textbf{JavaFX} que simule el funcionamiento de una cafetería,
creando clases que representen a los clientes y a los camareros de la misma, y utilizar \textbf{Threads} para modelar la interacción entre ellos. \\ \\
